...
it might happen that two containers have same port but we need to bind them to different host them those host/localhost makes communication to our desired container 
