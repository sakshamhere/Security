...
#https://medium.com/bili%C5%9Fim-hareketi/owasp-istanbul-vulnerable-flask-app-f45b3cd9aa85
...
def search_user(name):
    ...
    # cur.execute("select * from test where username = '' or '1=1'" % name)
...
def user_pass_control():
    ...
    if re.search(username,password):
        return "sa" #jsonify(data="Password include username"), 200
    else:
