...
1. `Blue`- https://tryhackme.com/room/blue
         ...
         - Intial access by explopiting Eternal Blue
         - Although this already provides us NT Authority privilege, but for learning purpose we can use this know Kernel Exploits using Exploit Suggestor
