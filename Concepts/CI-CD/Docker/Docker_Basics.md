...
- docker exec -it <container id> -- bin/bash or bin/sh (we can get the terminal of running container, may be we want to navigate in directory inside of virtual file system)
